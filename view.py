...
class FindView():
    def __init__(self):
        ...
        # click it to rebuild output command
        rebuild_button = uw.Button(u"Rebuild")
        uw.connect_signal(rebuild_button, 'click', self.rebuild_clicked)
        self.rebuild_button = uw.AttrMap(rebuild_button,
        ...
        self.frame = uw.Frame(header=help,
                              ...
                              footer=uw.Columns([
                                  self.command_input,
                                  ('weight', 0.1, self.rebuild_button)]))
